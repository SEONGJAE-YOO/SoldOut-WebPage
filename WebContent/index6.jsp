  ...
  <div id="main">
    <header>  
      ...
      <nav>
          ...
          <li><a href="index.jsp">카테고리</a>
          	<ul>
           		<li><a href="running shoes.jsp" target="_self">운동화</a>
    ...
    <div id="site_content">
      <div id="sidebar_container">
        <div class="gallery">
          <ul class="images">
            <li class="show"><img width="450" height="450" src="images/e629aa2f.jpg" alt="photo_one" /></li>
            <li><img width="450" height="450" src="images/22ae1599.jpg" alt="photo_two" /></li>
            <li><img width="450" height="450" src="images/2338eda8.jpg" alt="photo_three" /></li>
            <li><img width="450" height="450" src="images/5f9b38e8.jpg" alt="photo_four" /></li>
            <li><img width="450" height="450" src="images/a15e854a.jpg" alt="photo_five" /></li>
          </ul>
        </div>
      </div>
      <div id="content">
        <h1>푸마 썬더 데져트 스팩트라</h1>
        <p class="thick">139,000원 </p>
