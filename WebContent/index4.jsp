  ...
  <div id="main">
    ...
    <div id="site_content">
      <div id="sidebar_container">
        <div class="gallery">  
          <ul class="images">
            <li class="show"><img width="450" height="450" src="images/1812159610_0000002.jpg" alt="photo_one" /></li>
            <li><img width="450" height="450" src="images/1812159610_0000003.jpg" alt="photo_two" /></li>
            <li><img width="450" height="450" src="images/1812159610_0000004.jpg" alt="photo_three" /></li>
            <li><img width="450" height="450" src="images/1812159610_0000005.jpg" alt="photo_four" /></li>
            <li><img width="450" height="450" src="images/1812159610_0000006.jpg" alt="photo_five" /></li>
          </ul>
        </div>
      </div>
      <div id="content">
        <h1>[폴더]휠라_운동화FILA_BARRICADEXT 97</h1>
        <p class="thick">70,000원 </p>
