  ...
  <div id="main">
    ...
    <div id="site_content">
      <div id="sidebar_container">
        <div class="gallery">
          <ul class="images">
            <li class="show"><img width="450" height="450" src="images/1212.jpg" alt="photo_one" /></li>
            <li><img width="450" height="450" src="images/600.jpg" alt="photo_two" /></li>
            <li><img width="450" height="450" src="images/CRT300RL.jpg" alt="photo_three" /></li>
            <li><img width="450" height="450" src="images/CRT300RL-2.jpg" alt="photo_four" /></li>
            <li><img width="450" height="450" src="images/CRT300RL-3.jpg" alt="photo_five" /></li>
          </ul>
        </div>
      </div>
      <div id="content">
        <h1>뉴발란스 씨알티300알엘 CRT300RL-White</h1>
        <p class="thick">71,160원 </p>
